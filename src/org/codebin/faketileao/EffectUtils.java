...
class EffectUtils {
	 ...
	 *           The image tp
	 * @param dst
	 *           The destination image to draw blured src image into, null if you
	...
	/**
	 * <p>
	 * Blurs the source pixels into the destination pixels. The force of the blur
	 * is specified by the radius which must be greater than 0.
	 * </p>
	 * <p>
	 ...
	 * image passed as a parameter. The returned image is only compatible with
